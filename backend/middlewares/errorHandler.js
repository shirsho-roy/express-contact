...
const errorHandler= async(err,req,res,next)=>{
    ...
    switch(statusCode){
        ...
        break;
        case constants.FORBIDDEN:res.json({title:"Foridden" ,message: err.message,stackTrace: err.stack});
        break;
        case constants.UNAUTHORISED:res.json({title:"Unauthorised" ,message: err.message,stackTrace: err.stack});
        break;
